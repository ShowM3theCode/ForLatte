...
namespace ForLatte {
	...
	struct Renderer2DData
	{
		...
		glm::vec2 QuadTextureCoordinations[4];
	...
	void Renderer2D::Init()
	{
		...
		s_Data.QuadTextureCoordinations[0] = { 0.0f, 0.0f };
		s_Data.QuadTextureCoordinations[1] = { 1.0f, 0.0f };
		s_Data.QuadTextureCoordinations[2] = { 1.0f, 1.0f };
		s_Data.QuadTextureCoordinations[3] = { 0.0f, 1.0f };
	}
	...
	void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const glm::vec4& color)
	{
		...
		for (uint32_t i = 0; i < 4; i++)
		{
			...
			s_Data.QuadVertexBufferPtr->TexCoord = s_Data.QuadTextureCoordinations[i];
